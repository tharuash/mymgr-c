...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function Vd(e){return Object.getPrototypeOf(e.prototype).constructor}function Md(e){for(var t=Vd(e.type),n=!0;t;){var r=void 0;if(Ft(e))r=t.ɵcmp||t.ɵdir;else{if(t.ɵcmp)throw new Error("Directives cannot inherit Components");r=t.ɵdir}if(r){if(n){var o=e;o.inputs=Fd(e.inputs),o.declaredInputs=Fd(e.declaredInputs),o.outputs=Fd(e.outputs);var i=r.hostBindings;i&&Bd(e,i);var a=r.viewQuery,u=r.contentQueries;a&&Hd(e,a),u&&Ld(e,u),N(e.inputs,r.inputs),N(e.declaredInputs,r.declaredInputs),N(e.outputs,r.outputs),e.afterContentChecked=e.afterContentChecked||r.afterContentChecked,e.afterContentInit=e.afterContentInit||r.afterContentInit,e.afterViewChecked=e.afterViewChecked||r.afterViewChecked,e.afterViewInit=e.afterViewInit||r.afterViewInit,e.doCheck=e.doCheck||r.doCheck,e.onDestroy=e.onDestroy||r.onDestroy,e.onInit=e.onInit||r.onInit}var s=r.features;if(s)for(var l=0;l<s.length;l++){var c=s[l];c&&c.ngInherit&&c(e),c===Md&&(n=!1)}}t=Object.getPrototypeOf(t)}}function Fd(e){return e===ze?{}:e===Qe?[]:e}function Hd(e,t){var n=e.viewQuery;e.viewQuery=n?function(e,r){t(e,r),n(e,r)}:t}function Ld(e,t){var n=e.contentQueries;e.contentQueries=n?function(e,r,o){t(e,r,o),n(e,r,o)}:t}function Bd(e,t){var n=e.hostBindings;e.hostBindings=n?function(e,r,o){t(e,r,o),n(e,r,o)}:t}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
